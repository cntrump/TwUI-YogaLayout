...
- (NSString *)debugDescription {
    return [NSString stringWithFormat:@"<%@: %p, isEnabled:%ld, isIncludedInLayout:%ld, isUIView:<bool:%ld, %@: %p>>",
            NSStringFromClass(self.class), self, (NSInteger)self.isEnabled, (NSInteger)self.isIncludedInLayout,
            (NSInteger)self.isUIView, NSStringFromClass(self.view.class), self.view];
}
